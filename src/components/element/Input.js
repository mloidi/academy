...
const InputText = styled.input`
  ...
  border-bottom: 2px solid
    ${props => (props.isValid ? props.theme.border : props.theme.errorColor)};
  text-align: start;
  ...
  &:focus {
    ...
    transition: 1s;
    border-color: ${props =>
      props.isValid ? props.theme.principal : props.theme.errorColor};
  }
`;
...
const InputSubmit = styled.input`
  background-color: ${props =>
    props.disabled ? 'lightgray' : props.theme.principal};
  padding: 0.5rem;
...
const Input = props => (
  <React.Fragment>
    ...
    {props.type === 'date' && <InputText {...props} />}
    {props.type === 'checkbox' && (
      <InputCheckBox>
